    ...
    <div>
      <nav className="relative px-4 py-1 flex justify-between items-center bg-white">
        <a className="text-3xl font-bold leading-none" href="#">
          <Image src="/alif-pustaka-logo.svg" alt="ap-logo" width={50} height={50}/>
        </a>
        <div className="lg:hidden">
          ...
          >
            <div className="">
              <Image src="/hamburger-menu-icon.svg" alt="Menu" width={30} height={30}/>
            </div>
          </button>
        </div>
      ...
      <div
        className="navbar-menu relative z-50 hidden" /* onClick={navbarMenu} */
      >
        <div
          className="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25" /* onClick={navbarBackdrop} */
        ></div>
